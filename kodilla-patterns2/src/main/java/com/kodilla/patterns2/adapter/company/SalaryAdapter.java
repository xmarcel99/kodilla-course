...
import com.kodilla.patterns2.adapter.company.oldhrsystem.SalarayCalculator;

import java.math.BigDecimal;
import java.util.ArrayList;
import java.util.List;

public class SalaryAdapter extends SalaryAdaptee implements SalarayCalculator {
